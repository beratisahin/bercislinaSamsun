    ...
    return (
        <div className="col-12">
            <div className="card m-4" style={{align:"center",backgroundColor:"#f8f7fb",borderRadius:"5px"}}>
               <Title 
                    page_loading="lazy" title="Blog"
               />
                <br/>
                
              <div class="col-12">
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b1} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b2} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b3} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b4} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
                  <h4 className="blogTitle">Lazer Epilasyonda Başarıyı etkileyen faktörler nelerdir?</h4>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b5} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
                ...
                <div className="col-lg-4 col-md-6 col-sm-12 col-12 blogtemplate" style={{height:"45rem",marginBottom:"3rem"}}>
                  <img src={b6} className="d-block img-responsive blogPhoto" loading="lazy" title="Samsun Lazer Epilasyon" alt="Samsun Lazer Epilasyon"></img>
